import "./_liveClock";
import { Card, CardHeader, EChart, PEV_PALETTE } from "snis-vaccination-dhis2";

/** Histogramme thème « pev » (palette OMS, axes discrets, menu d'export ≡). */
