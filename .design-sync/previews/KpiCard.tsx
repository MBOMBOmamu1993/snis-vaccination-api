import { KpiCard } from "snis-vaccination-dhis2";

/** Rangée de KPI comme sur l'onglet « Contrôle qualité des données ». */
export const IndicateursQualite = () => (
