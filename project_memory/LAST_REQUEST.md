...
Fichiers concernés : docs/index.html (nouveau moteur mkZsRender + MK_ZS_CFG +
  ...
  project_memory/*
Statut : TERMINÉ — 17 feuilles reprises (Supervision P1/P2/P3, Séances P1/P2,
  Taux d'abandon P1/P2, Livraison P1/P2, CDF P1/P2/NF, Vaccine expiration
  P1/P2, Vaccine dispo P1/P2, Infirmier P1/P2, Carte de Supervision en KPI) ;
  syntaxe JS OK ; harnais vert (builders + moteur, données réelles zone Aba) :
  ligne ZS en tête partout, plus de carte « Détail par aire de santé »
  séparée, ✓/✗ au lieu de Faux/Oui, compteur et exports sur la table fusionnée.
