...
LEVEL_CONFIGS = [
    {
        "name": "FOSA",
        "data_dir": DOCS / "data",
        "ou_map_path": DOCS / "data" / "ou_map.json.gz",
        "dash_dir": DOCS / "data" / "dashboard",
        "fields": ["_Province", "_ZS", "_Antenne", "_AS", "_FOSA", "_YM"],
        "split_by": "_Province",
        "has_heatmap": True,
        "heatmap_entity": "_FOSA",
        "include_pop": False
    },
    {
        "name": "AS",
        "data_dir": DOCS / "data_as",
        "ou_map_path": DOCS / "data_as" / "ou_map_as.json.gz",
        "dash_dir": DOCS / "data_as" / "dashboard",
        "fields": ["_Province", "_ZS", "_Antenne", "_AS", "_YM"],
        "split_by": "_Province",
        "has_heatmap": True,
        "heatmap_entity": "_AS",
        "include_pop": True
...
BASE_SUM_SPECS = {
    ...
    "VAR2_12_23": ["VAR2_12_23_mois_fixe1","VAR2_12_23_mois_avanc_1","VAR2_12_23_mois_mobile1","VAR2 12-23 mois fixe1","VAR2 12-23 mois mobile1"],
    "VAR2_12_23_fixe": ["VAR2_12_23_mois_fixe1","VAR2 12-23 mois fixe1"],
