...
SUM_SPECS: dict[str, list[str]] = {
 ...
 "BCG_utilis_es": ["BCG dose-utilisee"], "BCG_pertes": ["BCG dose-perdue"],
 "BCG_jours_rupture": ["BCG dose-jour rupture stock"], "BCG_stock_fin": ["BCG_stock_fin"],
 "DTC_utilis_es": ["DTC dose-utilisee"], "DTC_pertes": ["DTC doses-perdue"],
 "DTC_jours_rupture": ["DTC doses-jour rupture stock"], "DTC_stock_fin": ["DTC_stock_fin"],
 "VPO_utilis_es": ["VPO dose-utilisee"], "VPO_pertes": ["VPO dose-perdue"],
 "VPO_jours_rupture": ["VPO dose-jour rupture stock"], "VPO_stock_fin": ["VPO_stock_fin"],
 "VPI_utilis_es": ["VPI dose-utilisee"], "VPI_pertes": ["VPI dose-perdue"],
 "VPI_jours_rupture": ["VPI dose-jour rupture stock"], "VPI_stock_fin": ["VPI_stock_fin"],
 "VAR_utilis_es": ["VAR dose-utilisee"], "VAR_pertes": ["VAR dose-perdue"],
 "VAR_jours_rupture": ["VAR dose-jour rupture stock"], "VAR_stock_fin": ["VAR_stock_fin"],
 "VAA_utilis_es": ["VAA dose-utilisee"], "VAA_pertes": ["VAA dose-perdue"],
 "VAA_jours_rupture": ["VAA dose-jour rupture"], "VAA_stock_fin": ["VAA_stock_fin"],
 "Td_utilis_es": ["VAT dose-utilisee"], "Td_pertes": ["VAT dose-perdue"],
 "Td_jours_rupture": ["VAT dose-jour rupture"], "Td_stock_fin": ["VAT_stock_fin"],
 "PCV13_utilis_es": ["PCV13 dose-utilise"], "PCV13_pertes": ["PCV13 dose-perdue"],
 "PCV13_jours_rupture": ["PCV13 dose-jour rupture"], "PCV13_stock_fin": ["PCV13_stock_fin"],
 "ROTA_utilis_es": ["ROTA dose-utilise"], "ROTA_pertes": ["ROTA dose-perdue"],
 "ROTA_jours_rupture": ["ROTA dose-jour rupture"], "ROTA_stock_fin": ["ROTA_stock_fin"],
 "VAP_utilis_es": ["VAP dose-utilisee"], "VAP_pertes": ["VAP dose-perdue"],
 "VAP_jours_rupture": ["VAP dose-jour rupture"], "VAP_stock_fin": ["VAP_stock_fin"],
 "HPV_utilis_es": ["HPV dose-utilisee"], "HPV_pertes": ["HPV dose-perdue"],
 "HPV_jours_rupture": ["HPV dose-jour rupture"], "HPV_stock_fin": ["HPV_stock_fin"],
 ...
 # ── DILUANTS (rename_map) ──
 "Diluant_BCG_stock_d_but": ["Diluant BCG dose-stock debut mois"], "Diluant_BCG_re_ues": ["Diluant BCG dose-recue mois"],
 "Diluant_BCG_utilis_es": ["Diluant BCG dose-utilisee"], "Diluant_BCG_pertes": ["Diluant BCG dose-perdue"],
 "Diluant_BCG_stock_fin": ["Diluant_BCG_stock_fin"], "Diluant_BCG_jours_rupture": ["Diluant BCG dose-jour rupture"],
 "Diluant_VAR_stock_d_but": ["Diluant VAR dose-stock debut mois"], "Diluant_VAR_re_ues": ["Diluant VAR dose-recue mois"],
 "Diluant_VAR_utilis_es": ["Diluant VAR dose-utilisee"], "Diluant_VAR_pertes": ["Diluant VAR dose-perdue"],
 "Diluant_VAR_stock_fin": ["Diluant_VAR_stock_fin"], "Diluant_VAR_jours_rupture": ["Diluant VAR dose-jour rupture"],
 "Diluant_VAA_stock_d_but": ["Diluant VAA dose-stock debut mois"], "Diluant_VAA_re_ues": ["Diluant VAA dose-recue mois"],
 "Diluant_VAA_utilis_es": ["Diluant VAA dose-utilisee"], "Diluant_VAA_pertes": ["Diluant VAA dose-perdue"],
 "Diluant_VAA_stock_fin": ["Diluant_VAA_stock_fin"], "Diluant_VAA_jours_rupture": ["Diluant VAA dose-jour rupture"],
 ...
 "Diluant_VAP_stock_fin": ["Diluant_VAP_stock_fin"], "Diluant_VAP_jours_rupture": ["Diluant_VAP_jours_rupture"],
 # ── SAB (rename_map) ──
 "SAB_005ml_stock_d_but": ["SAB BCG 005ml dose-stock debut mois"], "SAB_005ml_re_ues": ["SAB BCG 005ml dose-recue mois"],
 "SAB_005ml_utilis_es": ["SAB BCG 005ml dose-utilisee"], "SAB_005ml_pertes": ["SAB BCG 005ml dose-perdue"],
 "SAB_005ml_stock_fin": ["SAB_005ml_stock_fin"], "SAB_005ml_jours_rupture": ["SAB BCG 005ml dose-jour rupture"],
 "SAB_05ml_stock_d_but": ["SAB 05ml dose-stock debut mois"], "SAB_05ml_re_ues": ["SAB 05ml dose-recue mois"],
 "SAB_05ml_utilis_es": ["SAB 05ml dose-utilisee"], "SAB_05ml_pertes": ["SAB 05ml dose-perdue"],
 "SAB_05ml_stock_fin": ["SAB_05ml_stock_fin"], "SAB_05ml_jours_rupture": ["SAB 05ml dose-jour rupture"],
 "SAB_auto_bloquante_stock_d_but": ["SAB 03ml dose-stock debut mois"], "SAB_auto_bloquante_re_ues": ["SAB 03ml dose-recue mois"],
 "SAB_auto_bloquante_utilis_es": ["SAB 03ml dose-utilisee"], "SAB_auto_bloquante_pertes": ["SAB 03ml dose-perdue"],
 "SAB_auto_bloquante_stock_fin": ["SAB_auto_bloquante_stock_fin"], "SAB_auto_bloquante_jours_rupture": ["SAB 03ml dose-jour rupture"],
 # ── SERINGUES DILUTION (rename_map) ──
 "Ser_dilution_2ml_stock_d_but": ["Dilution 2ml dose-stock debut mois"], "Ser_dilution_2ml_re_ues": ["Dilution 2ml dose-recue mois"],
 "Ser_dilution_2ml_utilis_es": ["Dilution 2ml dose-utilisee"], "Ser_dilution_2ml_pertes": ["Dilution 2ml dose-perdue"],
 "Ser_dilution_2ml_stock_fin": ["Ser_dilution_2ml_stock_fin"], "Ser_dilution_2ml_jours_rupture": ["Dilution 2ml dose-jour rupture"],
 "Ser_dilution_5ml_stock_d_but": ["Dilution 5ml dose-stock debut mois"], "Ser_dilution_5ml_re_ues": ["Dilution 5ml dose-recue mois"],
 "Ser_dilution_5ml_utilis_es": ["Dilution 5ml dose-utilisee"], "Ser_dilution_5ml_pertes": ["Dilution 5ml dose-perdue"],
 "Ser_dilution_5ml_stock_fin": ["Ser_dilution_5ml_stock_fin"], "Ser_dilution_5ml_jours_rupture": ["Dilution 5ml dose-jour rupture"],
 # ── ADAPTATEURS / COMPTE-GOUTTE / RÉCEPTACLES (rename_map) ──
 "Adaptateurs_stock_d_but": ["Adaptateur ROTAVIRUS dose-stock debut mois"], "Adaptateurs_re_ues": ["Adaptateur ROTAVIRUS dose-recue mois"],
 "Adaptateurs_utilis_es": ["Adaptateur ROTAVIRUS dose-utilisee"], "Adaptateurs_pertes": ["Adaptateur ROTAVIRUS dose-perdue"],
 "Adaptateurs_stock_fin": ["Adaptateurs_stock_fin"], "Adaptateurs_jours_rupture": ["Adaptateur ROTAVIRUS dose-jour rupture"],
 "Compte_goutte_stock_d_but": ["Compte-goutte dose-stock debut mois"], "Compte_goutte_re_ues": ["Compte-goutte dose-recue mois"],
 "Compte_goutte_utilis_es": ["Compte-goutte dose-utilisee"], "Compte_goutte_pertes": ["Compte-goutte dose-perdue"],
 "Compte_goutte_stock_fin": ["Compte_goutte_stock_fin"], "Compte_goutte_jours_rupture": ["Compte-goutte dose-jour rupture"],
 "R_ceptacles_stock_d_but": ["Receptacle dose-stock debut mois"], "R_ceptacles_re_ues": ["Receptacle dose-recue mois"],
 "R_ceptacles_utilis_es": ["Receptacle dose-utilisee"], "R_ceptacles_pertes": ["Receptacle dose-perdue"],
 "R_ceptacles_stock_fin": ["R_ceptacles_stock_fin"], "R_ceptacles_jours_rupture": ["Receptacle dose-jour rupture"],
}
