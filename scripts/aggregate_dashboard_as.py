...
SUM_SPECS: dict[str, list[str]] = {
    ...
    "BCG_stock_fin": ["BCG_stock_fin", "BCG dose-stock disponible utilisable"],
    "DTC_utilis_es": ["DTC_utilis_es"],
    "DTC_jours_rupture": ["DTC_jours_rupture"],
    "DTC_stock_fin": ["DTC_stock_fin", "DTC dose-stock disponible utilisable"],
    "VPO_utilis_es": ["VPO_utilis_es"],
    "VPO_jours_rupture": ["VPO_jours_rupture"],
    "VPO_stock_fin": ["VPO_stock_fin", "VPO dose-stock disponible utilisable"],
    "VPI_utilis_es": ["VPI_utilis_es"],
    "VPI_jours_rupture": ["VPI_jours_rupture"],
    "VPI_stock_fin": ["VPI_stock_fin", "VPI dose-stock disponible utilisable"],
    "VAR_utilis_es": ["VAR_utilis_es"],
    "VAR_jours_rupture": ["VAR_jours_rupture"],
    "VAR_stock_fin": ["VAR_stock_fin", "VAR dose-stock disponible utilisable"],
    "VAA_utilis_es": ["VAA_utilis_es"],
    "VAA_jours_rupture": ["VAA_jours_rupture"],
    "VAA_stock_fin": ["VAA_stock_fin", "VAA dose-stock disponible utilisable"],
    "Td_utilis_es": ["VAT_utilis_es"],
    "Td_jours_rupture": ["VAT_jours_rupture"],
    "Td_stock_fin": ["VAT_stock_fin", "VAT dose-stock disponible utilisable"],
    "PCV13_utilis_es": ["PCV13_utilis_es"],
    "PCV13_jours_rupture": ["PCV13_jours_rupture"],
    "PCV13_stock_fin": ["PCV13_stock_fin", "PCV13 dose-stock disponible utilisable"],
    "ROTA_utilis_es": ["ROTA_utilis_es"],
    "ROTA_jours_rupture": ["ROTA_jours_rupture"],
    "ROTA_stock_fin": ["ROTA_stock_fin", "ROTA dose-stock disponible utilisable"],
    "VAP_utilis_es": ["VAP_utilis_es"],
    "VAP_jours_rupture": ["VAP_jours_rupture"],
    "VAP_stock_fin": ["VAP_stock_fin", "VAP dose-stock disponible utilisable"],
