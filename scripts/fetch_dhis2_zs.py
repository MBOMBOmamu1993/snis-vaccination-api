...
class Dhis2Client:
    ...
    def analytics(self, dx_items: List[str], pe: str, ou: str = "LEVEL-3") -> dict:
        params = {
...
def _analytics_with_split(
    ...
    *,
    ...
    try:
        return client.analytics(dx_items=dx_items, pe=pe, ou="LEVEL-3")
...
def main() -> int:
    ...
    ap.add_argument("--out", default="docs/data_zs", help="Output folder")
